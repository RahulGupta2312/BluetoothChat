...
//                    String info = data.getExtras().getString("info");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        msg_field = (EditText) findViewById(R.id.msg_field);
        msg_send = (Button) findViewById(R.id.msg_send_btn);
        chatName = (TextView) findViewById(R.id.tv_chatNAME);
        instructions = (TextView) findViewById(R.id.tv_instructions);
        buttonSet = (LinearLayout) findViewById(R.id.btn_set_layout);
        msgLayout = (LinearLayout) findViewById(R.id.msg_field_layout);
